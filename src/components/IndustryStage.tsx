    ...
    >
      <div className="grid lg:min-h-[38rem] lg:grid-cols-[0.38fr_1fr]">
        <div className="relative z-20 flex flex-col border-b border-white/10 p-4 sm:p-5 lg:border-b-0 lg:border-r lg:p-8">
          ...
          <div
            className="mt-8 max-h-[22rem] space-y-1 overflow-y-auto pr-1 lg:mt-auto lg:max-h-[28rem]"
            role="tablist"
            ...
            {industrySolutions.map((industry, index) => {
              ...
              return (
                <button
                  ...
                  className={`group relative flex min-h-12 w-full cursor-pointer items-center gap-3 overflow-hidden rounded-xl px-3 text-left transition-colors duration-300 ${
                    selected
                      ? "bg-white text-void"
              ...
              >
                <div className="grid gap-6 lg:grid-cols-[1fr_0.8fr] lg:items-end">
                  <div>
                    ...
                    <h4 className="mt-3 max-w-xl font-display text-2xl font-bold tracking-[-0.045em] sm:text-3xl">
                      {active.name}
                    </h4>
                  ...
                  <div className="rounded-2xl border border-white/12 bg-black/35 p-4 backdrop-blur-xl">
                    ...
                    <ul className="mt-3 space-y-2.5">
                      {active.outcomes.map((outcome) => (
                        ...
                        >
                          <Check size={12} className="shrink-0 text-signal" />
                          {outcome}
                        </li>
                      ))}
                    </ul>
