...
export default async function Apply({searchParams}:{searchParams:Promise<Record<string,string|string[]|undefined>>}){const params=await searchParams;const get=(key:string)=>typeof params[key]==='string'?params[key] as string:'';return <ReferenceApply initialSystem={get('system')} initialIndustry={get('industry')} initialInterest={get('interest')}/>}
